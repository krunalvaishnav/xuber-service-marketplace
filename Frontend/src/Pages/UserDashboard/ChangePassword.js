...
import styles from "../../Styles/UserDashboardStyle/ChangePassword.module.css";
    ...
    <>
      ...
      <div className={styles.fullComponent}>
        ...
        {/*  <div className={styles.offCanvas}>
          <div
            className={styles.signin_form_container}
          ...
          >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <p className={styles.blank_message}>{formErrors.old_password}</p>
              <div className={styles.form_group}>
                <input
                  type="password"
                  name="password"
