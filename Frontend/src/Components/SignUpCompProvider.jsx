...
import styles from "../Styles/SignUpProvider.module.css"; // Add your CSS file for styling
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_BACKEND_URL}/provider/register`,
        formValues
      );
  ...
  return (
    <>
      <div className={styles.signin_form_container}>
        ...
        <h2 className={styles.signUpPara}>CREATE NEW ACCOUNT AS A PROVIDER</h2>
        <form onSubmit={handleSubmit}>
          ...
          {/* <p className={styles.note_password}><span>NOTE :</span> Min. length at least 2.</p> */}
