...
import styles from "../Styles/SignIn.module.css"; // Add your CSS file for styling
...
function LoginForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response) {
        if (
          err.response.data.error === "User not found! Please Create a account"
        ) {
          setError("User not found! Please Create a account");
  ...
  return (
    <div className={styles.signin_form_container}>
      ...
      <h2 className={styles.signInPara}>SIGN IN</h2>
