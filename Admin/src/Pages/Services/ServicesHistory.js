...
import styles from "../../Styles/Services/ServicesHistory.module.css";
  ...
  const getApi = async () => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_BACKEND_URL}/admin/request`
      );
      ...
      let requestData = response.data.AllRequest;
