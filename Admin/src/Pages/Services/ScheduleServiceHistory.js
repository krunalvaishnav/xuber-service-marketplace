...
import styles from "../../Styles/Services/ScheduleServiceHistory.module.css";
...
function ScheduleServiceHistory() {
  ...
  const getApi = async () => {
    try {
      const response = await axios.get(
        `${process.env.REACT_APP_BACKEND_URL}/admin/scheduled/request`
      );
      if ($.fn.DataTable.isDataTable("#userTable")) {
        $("#userTable").DataTable().destroy();
      }
      //   console.log(response.data.AllRequest);

      let requestData = response.data.AllScheduleRequest;
        ...
        <div className={styles.mainContent}>
          <div className={styles.tableDiv}>
            <div className={styles.table}>
              <h5>Schedule Request History</h5>
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th className="text-left">Schedule At</th>
                    ...
                    [...data].reverse().map((request, index) => (
                      <tr key={index}>
                        ...
                        <td style={{ color: "grey", fontWeight: "bold" }}>
                          ...
                          ,
                          {new Date(request.schedule_at).toLocaleTimeString(
                            "en-US",
                            {
                              timeZone: "UTC",
                              hour: "2-digit",
