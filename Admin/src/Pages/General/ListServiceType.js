...
import styles from "../../Styles/General/ListServiceType.module.css";
  ...
  const handleDelete = async () => {
    try {
      const response = await axios.delete(
        `${process.env.REACT_APP_BACKEND_URL}/admin/service/${serviceId.id}/delete`
      );
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th className="text-left">Service Image</th>
                    <th className="text-left">Service Name</th>
                    <th className="text-left">Provider Name</th>
                    <th className="text-left">Fixed Base Price</th>
                  ...
                  {data.length > 0 ? (
                    [...data].reverse().map((service, index) => (
                      <tr>
                        ...
                        <td className="text-left">{service.fixed}</td>
